...
const Outright = () => {
  return (
    <div>
      <div className='mb-4 pb-3 border-b border-foreground-200 uppercase font-medium'>Outright</div>
      <CountDownController />
        ...
        <table className='table-auto w-full border-collapse mt-4'>
          <thead>
            <tr className='bg-foreground-500 text-white'>
              ...
              <th className='py-2 text-center border border-foreground-400'>Forecast</th>
            </tr>
          </thead>
          <tbody>
            <tr>
